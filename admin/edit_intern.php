...
<div class="container mt-5">
    ...
    <form action="process_intern_edit.php?id=<?php echo $id; ?>" method="POST">
        ...
        <div class="mb-3">
            <label for="intern_name" class="form-label">Mobile Number</label>
            <input type="text" class="form-control" id="intern_name" name="mobile_number" value="<?php echo $mn; ?>" required>
        </div>
