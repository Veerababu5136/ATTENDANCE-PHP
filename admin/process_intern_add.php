...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $mn = mysqli_real_escape_string($connection, $_POST['mobile_number']);



    // SQL query to insert data into the interns table
    $query = "INSERT INTO interns (dss_id, name, batch_no,email,password,mobile_number) VALUES ('$dss_intern_id', '$intern_name', '$batch_id','$email','$password','$mn')";
